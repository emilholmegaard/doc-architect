...
class SpringRestApiScannerTest extends ScannerTestBase {
    ...
    void appliesTo_withJavaFiles_returnsTrue() throws IOException {
        // Given: Project with Java files and Spring Framework dependency
        createFile("src/main/java/com/example/Test.java", "public class Test {}");

        // Create mock dependency scan result with Spring Framework
        ScanResult depResult = new ScanResult(
            "maven-dependencies",
            true,
            List.of(),  // components
            List.of(new com.docarchitect.core.model.Dependency("test-component", "org.springframework", "spring-web", "6.0.0", "compile", true)),  // dependencies
