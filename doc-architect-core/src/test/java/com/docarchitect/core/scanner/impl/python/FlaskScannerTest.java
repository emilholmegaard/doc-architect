...
class FlaskScannerTest extends ScannerTestBase {
    ...
    void appliesTo_withPythonFiles_returnsTrue() throws IOException {
        // Given: Project with Python files and Flask dependency
        createFile("app/test.py", "print('hello')");

        // Create mock dependency scan result with Flask
        ScanResult depResult = new ScanResult(
            "pip-dependencies",
            true,
            List.of(),  // components
            List.of(new com.docarchitect.core.model.Dependency("test-component", "flask", "flask", "2.3.0", "runtime", true)),  // dependencies
